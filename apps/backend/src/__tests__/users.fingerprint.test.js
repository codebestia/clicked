...
function deriveFingerprint(identityKeys) {
    ...
    function bytesToSegment(buf, offset, length) {
        let value = BigInt(0);
...
describe('GET /users/:id/key-fingerprint', () => {
    ...
    it('returns a 60-digit fingerprint and 12 × 5-digit formatted safety number', async () => {
        ...
        const { fingerprint, formatted } = res.body;
...
//# sourceMappingURL=users.fingerprint.test.js.map